...
- ``cutmaster_ai.tools`` — ``register_tools(mcp: FastMCP) -> None``
...
- ``cutmaster_ai.panel_routes`` — ``register_routes(app: FastAPI) -> None``
...
log = logging.getLogger("cutmaster-ai.plugins")

TOOLS_GROUP = "cutmaster_ai.tools"
PANEL_ROUTES_GROUP = "cutmaster_ai.panel_routes"
