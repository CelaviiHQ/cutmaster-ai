...
Runs live at ``~/.cutmaster/cutmaster/<run_id>.json``.
"""
...
log = logging.getLogger("cutmaster-ai.cutmaster.state")

RUN_ROOT = Path.home() / ".cutmaster" / "cutmaster"
EXTRACT_ROOT = Path.home() / ".cutmaster" / "cutmaster" / "audio"
...
async def emit(
    ...
    *,
    ...
    JSON log mode (``CUTMASTER_LOG_FORMAT=json``).
