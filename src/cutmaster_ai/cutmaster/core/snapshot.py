...
Snapshots default to ``~/Documents/cutmaster-snapshots/``. Restore flow: user
...
DEFAULT_SNAPSHOT_DIR = Path.home() / "Documents" / "cutmaster-snapshots"
