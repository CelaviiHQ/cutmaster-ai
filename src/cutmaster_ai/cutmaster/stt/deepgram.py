...
- ``CUTMASTER_DEEPGRAM_MODEL`` — optional, defaults to ``"nova-3"``.
- ``CUTMASTER_DEEPGRAM_LANGUAGE`` — optional, defaults to ``"en"``.
"""
...
log = logging.getLogger("cutmaster-ai.cutmaster.stt_deepgram")


DEFAULT_MODEL = os.environ.get("CUTMASTER_DEEPGRAM_MODEL", "nova-3")
DEFAULT_LANGUAGE = os.environ.get("CUTMASTER_DEEPGRAM_LANGUAGE", "en")
