...
land under ``~/.cutmaster/cutmaster/per-clip-stt/<sha1>.json``. Re-running
...
log = logging.getLogger("cutmaster-ai.cutmaster.per_clip_stt")


CACHE_ROOT = Path.home() / ".cutmaster" / "cutmaster" / "per-clip-stt"
