...
``~/.celavii/cutmaster/audio-cues/v1/<sha1(wav_path)>/cues.json``.
...
log = logging.getLogger("celavii-resolve.cutmaster.audio_cues")


CACHE_ROOT = Path.home() / ".celavii" / "cutmaster" / "audio-cues" / "v1"
